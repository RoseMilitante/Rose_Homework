...
def scrape():
    ...
    #mars_complete_data['title'] = mars_soup.find('div', class_="content_title").get_text()
    #mars_complete_data['paragraph'] = mars_soup.find('div', class_="article_teaser_body").get_text()
    ...
    for image in featured_images:
        ...
        mars_complete_data[featured_image_url] = 'https://www.jpl.nasa.gov'+ photo_references
...
mars_complete_data['mars_hemispheres'] = mars_hemispheres   table = mars_table[0]
    ...
    mars_complete_data['table'] = table_data_html
